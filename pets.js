                    ...
                    <div class="princess-card h-100 d-flex flex-column">
                        <div class="card-img-container position-relative">
                            <img class="card-img-top responsive-img" 
                                 src="${item.img}" 
                                 alt="${item.title}"
                                 onerror="this.src='photos4/placeholder.jpg'">
                        </div>
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="player-info mb-2">
                                ...
                                <small class="text-muted d-block">
                                    <i class="fas fa-user me-1"></i> ${item.owner || 'No owner'}
                                </small>
                            </div>
                            ...
                            <div class="mt-auto">
                                <button class="btn btn-buy w-100 buy-btn" 
        ...
        if (node) {
            node.innerHTML = `
                <div class="col-12 text-center py-5">
                    ...
                    <h4 style="color: #4a2c5e;">Failed to load pets</h4>
                    <p style="color: #7b5a8c;">Please check that the file <strong>pets.json</strong> exists in the same folder.</p>
...
function addAnimationStyles() {
    if (document.getElementById('pet-modal-styles')) return;

    const styles = document.createElement('style');
    styles.id = 'pet-modal-styles';
    styles.textContent = `
        @keyframes fadeIn {
            from { opacity: 0; }
            to { opacity: 1; }
